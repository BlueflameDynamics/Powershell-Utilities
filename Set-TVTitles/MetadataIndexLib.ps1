...
may vary with Windows Versions, each directory, and PC to PC. 
Some applications may extend the index with custom properties of their own.
#>
...
.SYNOPSIS
This function gets the Index value associated with a property name.
...
<#
Import-Module .\MetadataIndexLibT.ps1 -Force
